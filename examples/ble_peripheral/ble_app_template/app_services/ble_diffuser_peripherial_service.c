...
static uint8_t fan_value[1] = {0xFF};
static uint8_t main_button_value[1] = {0xFF};
...
/*
uint32_t leds_buttons_configure()
{
    uint32_t err_code;

    err_code = bsp_event_to_button_action_assign(BTN_ID_LED0,
                                                 BTN_ACTION_LED_SWITCH,
                                                 BSP_EVENT_KEY_0);
    RETURN_ON_ERROR_NOT_INVALID_PARAM(err_code);

    err_code = bsp_event_to_button_action_assign(BTN_ID_LED1,
                                                 BTN_ACTION_LED_SWITCH,
                                                 BSP_EVENT_KEY_1);
    RETURN_ON_ERROR_NOT_INVALID_PARAM(err_code);

    err_code = bsp_event_to_button_action_assign(BTN_ID_LED2,
                                                 BTN_ACTION_LED_SWITCH,
                                                 BSP_EVENT_KEY_2);
    RETURN_ON_ERROR_NOT_INVALID_PARAM(err_code);
